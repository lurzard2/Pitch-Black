...
public class DreamerGraphics : PBEntity.GraphicsModule
{
    ...
    public override void Update(bool eu)
    {
        ...
        pos = Dreamer.Pos + new Vector2(0f, Mathf.Sin(sinBob * 3.1415927f * 2f) * 18f * scale);
    ...
    public class Rags
    {
        public Rags(DreamerGraphics dreamer, int firstSprite)
        {
        ...
        public DreamerGraphics dreamer;
    ...
    public class Chains
    {
        public Chains(DreamerGraphics dreamer, int firstSprite)
        {
            this.dreamer = dreamer;
            this.firstSprite = firstSprite;
            int array = 2;
    ...
    public void AfterEncounteredVisual()
    {
        ...
        if (data.destPos == null || (Dreamer.visibleEntity as DreamerGraphics).scale <= 0.01f)
        {
            AddRippleRing();
