...
Shader "Futile/EtherealSkin" //Unlit Transparent Vertex Colored Additive 
{
Properties 
	{
...
uniform half4 _GhostSkinHighlightColor;
...
return lerp(_GhostSkinColor, _GhostSkinHighlightColor, glimmer);
